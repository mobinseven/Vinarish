...
namespace VinarishMvc.Data
{
    ...
    public partial class ApplicationDbContext : IdentityDbContext<VinarishUser>
    {
        ...
        private void WagonMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Wagon>().Property<int>(x => x.WagonId).HasColumnName(@"WagonId").IsRequired().ValueGeneratedOnAdd();
        ...
        private void DeviceTypeMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<DeviceType>().Property<int>(x => x.DeviceTypeId).HasColumnName(@"DeviceTypeId").IsRequired().ValueGeneratedOnAdd();
            modelBuilder.Entity<DeviceType>().Property<string>(x => x.Name).HasColumnName(@"Name").IsRequired().ValueGeneratedNever();
            modelBuilder.Entity<DeviceType>().Property<int>(x => x.DepartmentId).HasColumnName(@"DepartmentId").ValueGeneratedNever();
        ...
        private void DeviceMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Device>().Property<int>(x => x.DeviceId).HasColumnName(@"DeviceId").IsRequired().ValueGeneratedOnAdd();
            modelBuilder.Entity<Device>().Property<int>(x => x.WagonId).HasColumnName(@"WagonId").ValueGeneratedNever();
            modelBuilder.Entity<Device>().Property<string>(x => x.Serial).HasColumnName(@"Serial").ValueGeneratedNever();
            modelBuilder.Entity<Device>().Property<System.DateTime?>(x => x.GuaranteeDate).HasColumnName(@"GuaranteeDate").ValueGeneratedNever();
            modelBuilder.Entity<Device>().Property<int>(x => x.DevicePlaceId).HasColumnName(@"DevicePlaceId").ValueGeneratedNever();
            modelBuilder.Entity<Device>().HasKey(@"DeviceId");
            modelBuilder.Entity<Device>().HasIndex(@"Serial").IsUnique(true);
        }
        ...
        private void ReportMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Report>().Property<int>(x => x.DeviceId).HasColumnName(@"DeviceId").ValueGeneratedNever();
            ...
            modelBuilder.Entity<Report>().Property<int>(x => x.DeviceStatusId).HasColumnName(@"DeviceStatusId").ValueGeneratedNever();
        ...
        private void ReporterMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Reporter>().Property<int>(x => x.DepartmentId).HasColumnName(@"DepartmentId").ValueGeneratedNever();
        ...
        private void DeviceStatusMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<DeviceStatus>().Property<int>(x => x.StatusId).HasColumnName(@"StatusId").IsRequired().ValueGeneratedOnAdd();
        ...
        private void WagonTripMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<WagonTrip>().Property<int>(x => x.WagonTripId).HasColumnName(@"WagonTripId").IsRequired().ValueGeneratedOnAdd();
            modelBuilder.Entity<WagonTrip>().Property<int>(x => x.WagonId).HasColumnName(@"WagonId").ValueGeneratedNever();
            modelBuilder.Entity<WagonTrip>().Property<int>(x => x.TrainTripId).HasColumnName(@"TrainTripId").ValueGeneratedNever();
        ...
        private void DepartmentMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Department>().Property<int>(x => x.DepartmentId).HasColumnName(@"DepartmentId").IsRequired().ValueGeneratedOnAdd();
        ...
        private void TrainTripMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TrainTrip>().Property<int>(x => x.TrainTripId).HasColumnName(@"TrainTripId").IsRequired().ValueGeneratedOnAdd();
        ...
        private void DevicePlaceMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<DevicePlace>().Property<int>(x => x.DevicePlaceId).HasColumnName(@"DevicePlaceId").IsRequired().ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity<DevicePlace>().Property<int>(x => x.DeviceTypeId).HasColumnName(@"DeviceTypeId").ValueGeneratedNever();
        ...
        #region Wagon Navigation properties
            ...
            modelBuilder.Entity<Wagon>().HasMany(x => x.Devices).WithOne(op => op.Wagon).OnDelete(DeleteBehavior.Restrict).IsRequired(true).HasForeignKey(@"WagonId");
        ...
        #region Device Navigation properties

            modelBuilder.Entity<Device>().HasOne(x => x.Wagon).WithMany(op => op.Devices).OnDelete(DeleteBehavior.Restrict).IsRequired(true).HasForeignKey(@"WagonId");
            modelBuilder.Entity<Device>().HasMany(x => x.MalfunctionReports).WithOne(op => op.Device).OnDelete(DeleteBehavior.Restrict).IsRequired(true).HasForeignKey(@"DeviceId");
            modelBuilder.Entity<Device>().HasOne(x => x.DevicePlace).WithMany(op => op.Devices).OnDelete(DeleteBehavior.Restrict).IsRequired(true).HasForeignKey(@"DevicePlaceId");

        #endregion

        #region Report Navigation properties

            modelBuilder.Entity<Report>().HasOne(x => x.Device).WithMany(op => op.MalfunctionReports).OnDelete(DeleteBehavior.Restrict).IsRequired(true).HasForeignKey(@"DeviceId");
            ...
            modelBuilder.Entity<Report>().HasMany(x => x.AppendixReports).WithOne(op => op.Report1).OnDelete(DeleteBehavior.Restrict).IsRequired(false).HasForeignKey(@"AppendixReportId");
            modelBuilder.Entity<Report>().HasOne(x => x.Report1).WithMany(op => op.AppendixReports).OnDelete(DeleteBehavior.Restrict).IsRequired(false).HasForeignKey(@"AppendixReportId");
        ...
        #region DevicePlace Navigation properties
            ...
            modelBuilder.Entity<DevicePlace>().HasMany(x => x.Devices).WithOne(op => op.DevicePlace).OnDelete(DeleteBehavior.Restrict).IsRequired(true).HasForeignKey(@"DevicePlaceId");
