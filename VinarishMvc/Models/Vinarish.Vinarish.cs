...
namespace VinarishMvc.Data
{
    ...
    public partial class ApplicationDbContext : IdentityDbContext<VinarishUser>
    {
        ...
        private void DeviceMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Device>().Property<string>(x => x.Code).HasColumnName(@"Code").IsRequired().ValueGeneratedNever();
            modelBuilder.Entity<Device>().Property<string>(x => x.Description).HasColumnName(@"Description").IsRequired().ValueGeneratedNever();
            modelBuilder.Entity<Device>().Property<int>(x => x.DeviceTypeId).HasColumnName(@"DeviceTypeId").ValueGeneratedNever();
            ...
            modelBuilder.Entity<Device>().HasIndex(@"Code").IsUnique(true);
        ...
        #region DeviceType Navigation properties
            ...
            modelBuilder.Entity<DeviceType>().HasMany(x => x.Devices).WithOne(op => op.DeviceType).OnDelete(DeleteBehavior.Restrict).IsRequired(true).HasForeignKey(@"DeviceTypeId");
        ...
        #region Device Navigation properties
            ...
            modelBuilder.Entity<Device>().HasOne(x => x.DeviceType).WithMany(op => op.Devices).OnDelete(DeleteBehavior.Restrict).IsRequired(true).HasForeignKey(@"DeviceTypeId");
